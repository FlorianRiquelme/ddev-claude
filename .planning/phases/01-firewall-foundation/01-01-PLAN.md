...
must_haves:
  ...
  artifacts:
    ...
    - path: ".ddev/docker-compose.firewall.yaml"
      provides: "Capability grants and ENTRYPOINT override"
      contains: "NET_ADMIN"
...
- `healthcheck` block exists with test command
  ...
  <done>docker-compose.firewall.yaml grants NET_ADMIN/NET_RAW, overrides ENTRYPOINT, and configures healthcheck</done>
</task>
